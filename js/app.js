...
function mostrarAlerta(mensaje){
  ...
  if(!existeAlerta){
    ...
    alerta.classList.add('bg-red-300', 'border', 'border-red-400', 'text-red-700', 'px-4', 'py-3', 'rounded', 'max-w-lg', 'mx-auto', 'mt-6', 'text-center');
    alerta.innerHTML = `
...
async function buscarImagenes(){
  ...
  const key = '26074252-1c67a7773c865e067dc3e00d8';
...
function mostrarImagenes(imagenes){
  // Eliminar los resultados previos (Limpiar el HTML)
...
function imprimirPaginador(){
  ...
  while(true){
    ...
    // En caso de que no hayamos llegado al final, genera un botón por cada elemento en el generador
